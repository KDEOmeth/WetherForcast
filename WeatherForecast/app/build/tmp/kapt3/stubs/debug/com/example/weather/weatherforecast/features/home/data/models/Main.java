...
public final class Main implements android.os.Parcelable {
    ...
    private final double grndLevel = 0.0;
    ...
    private final double tempKf = 0.0;
    ...
    public final com.example.weather.weatherforecast.features.home.data.models.Main copy(double temp, double tempMin, double tempMax, double pressure, double seaLevel, double grndLevel, int humidity, double tempKf) {
        return null;
    }
