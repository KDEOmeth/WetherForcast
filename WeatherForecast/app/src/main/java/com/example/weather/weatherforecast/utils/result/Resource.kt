...
import com.example.weather.weatherforecast.utils.result.ResourceType.AUTH_FAILED_ERROR
import com.example.weather.weatherforecast.utils.result.ResourceType.CONNECTION_ERROR
import com.example.weather.weatherforecast.utils.result.ResourceType.EMPTY_DATA
import com.example.weather.weatherforecast.utils.result.ResourceType.ERROR
import com.example.weather.weatherforecast.utils.result.ResourceType.LOADING
import com.example.weather.weatherforecast.utils.result.ResourceType.SUCCESS
import com.example.weather.weatherforecast.utils.result.ResourceType.VALIDATION_ERROR
